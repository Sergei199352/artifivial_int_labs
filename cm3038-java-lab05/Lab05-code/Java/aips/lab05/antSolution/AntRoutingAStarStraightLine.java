...
public class AntRoutingAStarStraightLine extends BestFirstSearchProblem
{
public AntState goal;	//the goal state
public AntWorld world;	//the ant world

/**
 * Create an AntRoutingAStarStraightLine object.	
 * @param start	The initial state.
 * @param goal	The goal state.
 * @param world	The ant world.
 */
public AntRoutingAStarStraightLine(State start, State goal, AntWorld world) 
{
super(start, goal);
this.world=world;
} //end method
...
/**
 * This method overrides the evaluation method defined in the aips.search.informed.BestFirstSearchProblem class.
