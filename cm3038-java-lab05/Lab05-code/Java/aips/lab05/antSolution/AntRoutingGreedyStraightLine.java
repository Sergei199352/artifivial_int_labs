...
public class AntRoutingGreedyStraightLine extends AntRoutingAStarStraightLine
{
public AntRoutingGreedyStraightLine(State start, State goal, AntWorld world) 
{
